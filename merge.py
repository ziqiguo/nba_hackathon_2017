...
with open('shot_and_assist_data.csv', 'wb') as csvfile:
	...
	csv_writer.writerow(['GAME_ID', 'PLAYER_ID', 'Actual Assists', 'Expected Assists', 'Actual Points from Assists', 'Expected Points from Assists', 'Actual Points', 'Expected Points'])
