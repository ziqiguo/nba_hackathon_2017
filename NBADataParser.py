...
GAME_FILE_FORMAT = 'Raw Tracking Data/NBA_LG_FINAL_SEQUENCE_OPTICAL${0}_{1}.XML'
...
#print load_player_maps('Player_Map.csv')
#print load_team_maps('Team_Map.csv')
